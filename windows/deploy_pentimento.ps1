...
$PRODUCT_UID = "4d13d547-812e-4072-90ac-37acab3fc803"
...
$INSTALLER_FILE = Join-Path -Path $PSScriptRoot\installer\output -ChildPath "Pentimento Installer.exe"
$STORAGE_FID = "Pentimento-$Version.exe"
