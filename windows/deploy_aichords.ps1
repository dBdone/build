...
$PRODUCT_UID = "28dad868-5899-4b33-8bdc-dda5e26a5785"
...
$INSTALLER_FILE = Join-Path -Path $PSScriptRoot\installer\output -ChildPath "AI Chords Installer.exe"
$STORAGE_FID = "AIChords-$Version.exe"
