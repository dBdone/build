...
Source: "standalone\ONE-X.exe"; DestDir: "{app}"; DestName: "ONE-X-Standalone.exe"; Flags: ignoreversion
...
[Icons]
Name: "{group}\ONE-X Standalone"; Filename: "{app}\ONE-X-Standalone.exe"
